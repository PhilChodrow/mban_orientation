...
- `git` and GitHub: version control, collaboration, sharing. 
- `R` and RStudio: data exploration, statistics, machine learning, visualization. 
- `Julia` and `JuMP`: optimization. 

## Why `git` for Version Control?

- Break your workflow into manageable stages. 
- [Feature branching model](https://www.atlassian.com/git/tutorials/comparing-workflows/feature-branch-workflow) -- easy collaboration, code always production-ready.
