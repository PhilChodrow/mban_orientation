...
author: "Phil Chodrow, MIT ORC and LIDS"
...
- AirBnB has asked you, a data analytics consultant: 

> ***Where should we recruit more hosts?*** 

- They have given you a complex, multi-part data set.
- We will study the data using `R`. 
...
```{r, echo = FALSE, out.height = 550, out.width = 550}
...
3. Modify the dashboard: 
	...
	- `knit` your dashboard again. Save the `.Rmd` file. We're coming back to it! 
4. **FILL OUT FEEDBACK SURVEY** (link in email)
5. **Resources:** `R` graphics [cheatsheet](https://www.rstudio.com/wp-content/uploads/2015/03/ggplot2-cheatsheet.pdf), [`R` Graphics Cookbook](http://www.cookbook-r.com/Graphs/)
